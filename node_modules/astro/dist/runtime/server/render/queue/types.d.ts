...
import type { AstroComponentInstance } from 'astro/runtime/server/render/astro/instance.js';
import type { RenderInstruction } from 'astro/runtime/server/render/instruction.js';
import type { ServerIslandComponent } from 'astro/runtime/server/render/server-islands.js';
import type { NodePool } from 'astro/runtime/server/render/queue/pool.js';
import type { HTMLStringCache } from 'astro/runtime/server/html-string-cache.js';
/**
