import { a as bundledLanguagesInfo, i as bundledLanguagesBase, n as bundledLanguages, r as bundledLanguagesAlias, t as BundledLanguage } from "shiki/dist/langs-bundle-full-C-zczmvu.mjs";
import { BundledTheme, bundledThemes, bundledThemesInfo } from "shiki/themes";
import { Highlighter, codeToHast, codeToHtml, codeToTokens, codeToTokensBase, codeToTokensWithThemes, createHighlighter, getLastGrammarState, getSingletonHighlighter, t as bundle_full_d_exports } from "shiki/bundle/full";
import { BuiltinLanguage, BuiltinTheme } from "shiki/types";
